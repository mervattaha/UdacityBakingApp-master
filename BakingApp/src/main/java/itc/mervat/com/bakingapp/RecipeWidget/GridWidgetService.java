package itc.mervat.com.bakingapp.RecipeWidget;
...
import static itc.mervat.com.bakingapp.RecipeWidget.BakingWidgetProvider.ingredientsList;
...
public class GridWidgetService extends RemoteViewsService {
    ...
    class GridRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
        ...
        public RemoteViews getViewAt(int position) {
            ...
            RemoteViews views = new RemoteViews(mContext.getPackageName(), R.layout.baking_grid_view_item);
