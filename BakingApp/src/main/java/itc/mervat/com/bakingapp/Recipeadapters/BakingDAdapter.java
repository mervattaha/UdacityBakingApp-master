...
public class BakingDAdapter extends RecyclerView.Adapter<BakingDAdapter.RecyclerViewHolder> {
    ...
    public BakingDAdapter(ListItemClickListener listener) {
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        int layoutIdForListItem = R.layout.baking_items;
